 ...
 * 
 * Classe de interaÁ„o com o DAO {@link EmpresaDAO}, realiza as tratativas
...
public class EmpresaController {
	 ...
	 * Cria Empresa
	 * 
	 * Recebe os dados da empresa e cria todos os dados e chama os DAO necess√°rios
	 * para a cria√ß√£o da empresa e por ultimo chama o DAO da empresa para salvar no
	 * banco.
	 * 
	 * @param nomeEmpresa
	 ...
	 * Deletar Empresa.
	 * 
	 * Deleta a Empresa passado como par√¢metro.
	 * 
	 * @param empresa Empresa a ser deletado
	 * 
	 * @return true caso seja deletado ou false caso contr√°rio
	 */
	...
	/**
	 * Metodo que faz a atualiza√ß√£o dos dados
	 * 
	 * cria uma nova empresa com os dados recebidos e os altera na empresa passado
	 * como par√¢metro chamando o DAO da empresa.
	 * 
	 * @param id
	 * @param nomeEmpresa
	 * @param dataInicioContrato
	 ...
	 * Busca empresa.
	 * 
	 * Busca a Empresa cujo id √© igual ao passado como par√¢metro.
	 * 
	 * @param id Do colaborador desejado.
	 * 
	 * @return Colaborador ou null caso n√£o encontrado.
	 */
	 ...
	 * 
	 * MÈtodo busca as empresas no banco de dados atravÈs dos seus respectivos
	 * nomes, È possÌvel passar um par‚metro parcial para retorna todos os registros
