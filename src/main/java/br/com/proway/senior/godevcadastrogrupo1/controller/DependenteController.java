...
public class DependenteController {
	 ...
	 * @param String           telefoneFamiliar Telefone familiar, utilizado para
	 *                         contato de emergencia.
	 * @return Retorna o Dependente caso tenha sido cadastrado ou null caso
	 *         contrario
	 */
	public static Dependente cadastrarDependente(String nome, String sobrenome, LocalDate dataDeNascimento,
		...
		Director.cadastrarDependente(builder, nome, sobrenome, dataDeNascimento, nacionalidade, pcd, genero,
	 ...
	 */
	public static Dependente atualizarDependente(Integer id, String nome, String sobrenome,
			LocalDate dataDeNascimento, String nacionalidade, boolean pcd, String genero,
			IdentidadeGenero identidadeGenero, String cpf, TiposDependentes tipoDependente,
			boolean optanteIR) {
		PessoaBuilder builder = new PessoaBuilder();
		Director.cadastrarDependente(builder, nome, sobrenome, dataDeNascimento, nacionalidade, pcd, genero,
				identidadeGenero, cpf, tipoDependente, optanteIR);
	 ...
	 * 
	 * Buscar todos os dependentes no banco de dados que tem nome igual ao passado
	 * como parametro.
	 * 
	 * @param nome
	 * @return
	 ...
	 * 
	 * Busca o Dependente relacionado ao Colaborador cujo id eh igual ao passado
	 * como parametro.
	 * 
