...
public class EnderecoControllerApiTest {
	...
	public void testBuscarEnderecoDoColaborador() throws Exception {
		Colaborador c = ColaboradorController.cadastrarColaborador("Brian", "Santos", "Erika", data, "Venezuelano",
				"Blumenauense", true, null, ig, Escolaridade.MEDIO_INCOMPLETO, EstadoCivil.DIVORCIADO, "Marta Pereira",
				"Joao Gomes", "09619039610", "mg14388606", 8, null, false, false, data, false, null, "brian@gmail.com",
				null, null, null, null, "54126547", "Teste Endereco", "Teste Endereco", "Teste Endereco",
				"Teste Endereco", "4521452015", "5421452103", "brian.santos@empresa.com.br", "1542413655", te, null,
				true, "banco00", "055", "438614625", "154", "Joãozinho", "Santos", data, "Venezuelano", true, null, ig,
				"09619039610", td, true);
	...
	public void testBuscarTodosEnderecos() throws Exception {
		Colaborador colaborador = ColaboradorController.cadastrarColaborador("Brian", "Santos", "Erika", data,
				"Venezuelano", "Blumenauense", true, null, ig, Escolaridade.MEDIO_INCOMPLETO, EstadoCivil.DIVORCIADO,
				"Marta Pereira", "Joao Gomes", "09619039610", "mg14388606", 8, null, false, false, data, false, null,
				...
				"Venezuelano", true, null, ig, "09619039610", td, true);
